...
declare module '@kingjan1999/xmlrpc-des' {
    ...
    namespace xmlrpc {
        ...
        interface Client {
            ...
            methodCall(method: string, params: any[], callback: (error: Object, value: any) => void, socketCallback: (socket) => void): void;
        ...
        export class deserializer {
            ...
            deserializeMethodResponse(stream: ReadableStream, callback: (error: any, value: any) => void) : void;
            deserializeMethodCall(stream: ReadableStream, callback: (error: any, value: any) => void) : void;
        }
    }
